...
describe('Blockchain', () => {
  describe('Correctly verifies data', () => {
    it('should return valid btc data', async () => {
        ...
        assert.equal(blockchains.btc.messagePrefix, '\u0018Bitcoin Signed Message:\n');
    ...
    it('should return valid flux data', async () => {
        ...
        assert.equal(blockchains.flux.messagePrefix, '\u0018Zelcash Signed Message:\n');
    ...
    it('should return valid doge data', async () => {
        ...
        assert.equal(blockchains.doge.messagePrefix, '\u0019Dogecoin Signed Message:\n');
    ...
    it('should return valid ltc data', async () => {
        ...
        assert.equal(blockchains.ltc.messagePrefix, '\u0019Litecoin Signed Message:\n');
    ...
    it('should return valid bch data', async () => {
        ...
        assert.equal(blockchains.bch.messagePrefix, '\u0018Bitcoin Signed Message:\n');
    ...
    it('should return valid rvn data', async () => {
        ...
        assert.equal(blockchains.rvn.messagePrefix, '\u0016Raven Signed Message:\n');
    ...
    it('should return valid zec data', async () => {
        ...
        assert.equal(blockchains.zec.messagePrefix, '\u0018Zcash Signed Message:\n');
    ...
    it('should return valid btcTestnet data', async () => {
        ...
        assert.equal(blockchains.btcTestnet.messagePrefix, '\u0018Bitcoin Signed Message:\n');
    ...
    it('should return valid btcSignet data', async () => {
        ...
        assert.equal(blockchains.btcSignet.messagePrefix, '\u0018Bitcoin Signed Message:\n');
    ...
    it('should return valid fluxTestnet data', async () => {
        ...
        assert.equal(blockchains.fluxTestnet.messagePrefix, '\u0018Zelcash Signed Message:\n');
    ...
    it('should return valid sepolia data', async () => {
        ...
        assert.equal(blockchains.sepolia.factoryAddress, '0xA76f98D25C9775F67DCf8B9EF9618d454D287467');
        assert.equal(blockchains.sepolia.entrypointAddress, '0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789');
        ...
        assert.equal(blockchains.sepolia.tokens[0].name, 'Testnet Ethereum Sepolia');
        assert.equal(blockchains.sepolia.tokens[0].symbol, 'TEST-ETH');
        assert.equal(blockchains.sepolia.tokens[0].decimals, 18);
        assert.equal(blockchains.sepolia.tokens[1].contract, '0x690cc0235aBEA2cF89213E30D0F0Ea0fC054B909');
    ...
    it('should return valid eth data', async () => {
        ...
        assert.equal(blockchains.eth.factoryAddress, '0xA76f98D25C9775F67DCf8B9EF9618d454D287467');
        assert.equal(blockchains.eth.entrypointAddress, '0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789');
        ...
        assert.equal(blockchains.eth.tokens[1].contract, '0x720cd16b011b987da3518fbf38c3071d4f0d1495');
        ...
        assert.equal(blockchains.eth.tokens[2].contract, '0xdac17f958d2ee523a2206206994597c13d831ec7');
        ...
        assert.equal(blockchains.eth.tokens[3].contract, '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48');
