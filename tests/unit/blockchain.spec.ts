...
describe('Blockchain', () => {
  describe('Correctly verifies data', () => {
    it('should return valid btc data', async () => {
        await assert.deepEqual(blockchains.btc, btc);
    });
    
    it('should return valid flux data', async () => {
        await assert.deepEqual(blockchains.flux, flux);
    });

    it('should return valid doge data', async () => {
        await assert.deepEqual(blockchains.doge, doge);
    });

    it('should return valid ltc data', async () => {
        await assert.deepEqual(blockchains.ltc, ltc);
    });

    it('should return valid bch data', async () => {
        await assert.deepEqual(blockchains.bch, bch);
    });

    it('should return valid rvn data', async () => {
        await assert.deepEqual(blockchains.rvn, rvn);
    });

    it('should return valid zec data', async () => {
        await assert.deepEqual(blockchains.zec, zec);
    });
    
    it('should return valid btcTestnet data', async () => {
        await assert.deepEqual(blockchains.btcTestnet, btcTestnet);
    });

    it('should return valid btcSignet data', async () => {
        await assert.deepEqual(blockchains.btcSignet, btcSignet);
    });

    it('should return valid fluxTestnet data', async () => {
        await assert.deepEqual(blockchains.fluxTestnet, fluxTestnet);
    });

    it('should return valid sepolia data', async () => {
        await assert.deepEqual(blockchains.sepolia, sepolia);
    });

    it('should return valid eth data', async () => {
        await assert.deepEqual(blockchains.eth, eth);
    });
  });
